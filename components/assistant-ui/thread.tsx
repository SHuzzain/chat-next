...
const ThreadWelcome: FC = () => {
  return (
    <div className="aui-thread-welcome-root mb-8 flex flex-col items-center gap-3 px-4 text-center">
      <div className="bg-muted flex  items-center justify-center rounded-2xl p-1.5">
        <Image src="/champ.svg" alt="Logo" width={56} height={56} className="text-foreground" />
      </div>
      <div className="space-y-1">
        <h1 className="aui-thread-welcome-message-inner fade-in slide-in-from-bottom-1 animate-in fill-mode-both text-xl font-semibold tracking-tight duration-200">
          How can I help you today?
        </h1>
        <p className="text-muted-foreground text-sm">
          Ask about courses, centres, learners, and more.
        </p>
      </div>
    </div>
  );
...
const WELCOME_SUGGESTIONS = [
  { title: "My courses", prompt: "Show my enrolled courses" },
  { title: "Find a centre", prompt: "Help me find a course centre" },
  { title: "Attendance", prompt: "How do I check attendance?" },
] as const;
...
const ThreadSuggestions: FC = () => {
  ...
  return (
    <div className="aui-thread-welcome-suggestions flex w-full flex-wrap items-center justify-center gap-2 px-3 pb-1">
