...
const ChatHeader = ({ onClose }: ChatHeaderProps) => {
    return (
        <div className="flex items-center justify-between bg-card dark:bg-[#1e2b3c] text-card-foreground p-2 border-b border-border">
            {/* Logo */}
            ...
            <Button
                size={"icon"}
                variant="secondary"
                className='rounded-full size-8 dark:bg-[#14222f] dark:text-white'
                onClick={onClose}
            >
